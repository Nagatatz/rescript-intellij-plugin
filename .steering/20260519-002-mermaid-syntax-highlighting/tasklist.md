...
- [x] `./gradlew ktlintCheck buildPlugin test koverHtmlReport koverVerify verifyPluginStructure` が緑 (タスクを個別に実行)
- [x] DoD Phase 3 自己検証 (KDoc 完備、deprecated API 不使用、colorizer は internal で外部入力を escape)
